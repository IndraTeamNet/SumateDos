...
if(f){c.buttons.info(c.i18n("buttons.copyTitle","Copiado al portapapeles"),c.i18n("buttons.copySuccess",{1:"1 fila copiada al portapapeles",_:"%d filas copiadas al portapapeles"},a.rows),2E3);return}}catch(h){}}f=i("<span>"+c.i18n("buttons.copyKeys","Press <i>ctrl</i> or <i>⌘</i> + <i>C</i> to copy the table data<br>to your system clipboard.<br><br>To cancel, click this message or press escape.")+"</span>").append(d);c.buttons.info(c.i18n("buttons.copyTitle","Copiado al portapapeles"),f,0);b[0].focus();b[0].select();
